...
from pyecharts import GeoLines, Style, Grid, Overlap

#地图名称
map_name = "1948-1949年，军校迁徙路线"
...
def plot_geolines(plot_set, coords_set, name_set, map_name):
    ...
    style_geolines = style.add(is_label_show=True,
                               ...
                               label_color=['#a6cee3','#1f78b4','#b2df8a','#33a02c','#fb9a99','#e31a1c','#fdbf6f','#ff7f00','#cab2d6','#6a3d9a','#ffff99''#ffffd9','#edf8b1','#c7e9b4','#7fcdbb','#41b6c4','#1d91c0','#225ea8','#253494','#081d58'],
